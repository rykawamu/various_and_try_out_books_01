...
//indepimage[Perplexity_AI_search_01][設定→検索エンジン→検索エンジンとサイト内検索を管理するをクリック][scale=0.6]{
//}

//indepimage[Perplexity_AI_search_02][サイト内検索の「追加」をクリック][scale=0.6]{
//}

//indepimage[Perplexity_AI_search_03][検索エンジン追加ダイアログ][scale=0.6]{
//}

//indepimage[Perplexity_AI_search_04][検索エンジン、ショートカット、URLの追加][scale=0.6]{
//}

//indepimage[Perplexity_AI_search_05][追加確認][scale=0.6]{
//}

//indepimage[Perplexity_AI_search_06][URL欄にショートカットを入力][scale=0.6]{
//}

//indepimage[Perplexity_AI_search_07][スペースを押し、Perplexity AIで検索を切り替え][scale=0.6]{
//}

//indepimage[Perplexity_AI_search_08][Perplexity AIで検索するキーワードを入力][scale=0.6]{
//}

//indepimage[Perplexity_AI_search_09][Perplexity AI上で検索結果が表示される][scale=0.6]{
//}
...
一方で、ChatGPTの回答は不正解です。ですが、自信が持ち合わせているデータをもとにして推論して回答を答えっている、という封印みると非常に興味深いなんと感じます。
