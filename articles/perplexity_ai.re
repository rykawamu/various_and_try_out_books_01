 ...
 * 最新の情報や複数の情報源に基づく回答が得られる。また、回答の根拠となるウェブサイトの情報も同時に表示される。そのため、信頼性が高い。
...
検索キーワードの入力後にEnterキーを押下すると、Perplexity AIが検索結果を出力します。
検索結果には、参照元のリンクもあります。
...
質問については、2022年に放送されたアニメ『@<b>{機動戦士ガンダム　水星の魔女}』を題材にして、あらすじと主人公についてそれぞれ聞いてみます。
...
そのうち、検索することは「ググる」から「パプる」へ変わっていくのですかね。
